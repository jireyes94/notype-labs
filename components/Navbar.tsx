    ...
    <>
      ...
      <nav className="fixed top-0 left-0 z-[100] w-full h-20 px-6 flex justify-between items-center border-b border-white/5 bg-black/60 backdrop-blur-xl text-white">
        ...
        <div className="flex items-center gap-6 md:gap-10">
          ...
          <button className="hidden md:flex items-center gap-3 bg-red-600 hover:bg-red-700 text-white px-5 py-2.5 rounded-full transition-all shadow-[0_0_20px_rgba(220,38,38,0.3)] group/cart">
            {/* Icono de Carrito */}
            <svg 
